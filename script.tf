...
resource "aws_instance" "webserver1" {
    ...
    user_data = <<-EOF
               ...
               echo "<h1>Welcome to KN University<h1>" | sudo tee /var/www/html/index.html
    EOF

     tags = {
    "Name" = "webserver-sub1-2"
  }
}
...
resource "aws_volume_attachment" "webserver-vol2" {
 ...
 count       = "1"
 volume_id   = "kings2"
 instance_id = "Webkings2"


}

# Application load balancer
resource "aws_lb" "knuniversitylb" {
...
resource "aws_route53_zone" "zyuniversity" {
  name = "www.knuniversity.edu"
}

# Create S3 bucket
resource "aws_s3_bucket" "knuniversity-edu" {
  bucket = "knunivers1stbuck"
  acl    = "public-read"

  tags = {
    Name        = "knunivers1stbuck"
    Environment = "Prod"
  }
}
             # Autoscalling group
